...
if __name__ == '__main__':
    ...
    ref_file_name = 'us_market_allderv_shiftedDays_1019.py'
    # ref_file_name = 'us_market_allderv_shiftedDays_1019_.py'
    file_name = path_processed_datasets + ref_file_name + ".csv"
    processed_4form_df = pd.read_csv(file_name, index_col=0)
    # ----------------------------------------------------------------------------------------------------------------

    # ---------------------------------------------------------------------------------------------------------------
    processed_4form_df = processed_4form_df[processed_4form_df.my_derivative_types.isin(['AB', 'B'])]
    # ---------------------------------------------------------------------------------------------------------------
