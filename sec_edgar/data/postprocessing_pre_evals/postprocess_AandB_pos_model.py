...
class PostProcess4FormPosAandB(object):
    """
    ...
    def post_process_df(form4_df):
        # TODO: check is ok
        post_processed_4form_df = form4_df.copy()
        ...
        return post_processed_4form_df
...
if __name__ == '__main__':
    ...
    processed_form4_df_model = processed_4form_df[processed_4form_df['transactionSharesAdjust'] > 0]
