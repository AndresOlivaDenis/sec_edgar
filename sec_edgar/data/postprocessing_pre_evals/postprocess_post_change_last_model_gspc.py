...
class PostProcessPosChangeLastGSPC(object):
    """
    ...
    def post_process_df(form4_df,
                        ...
                        gspc_price_column='GSPC Price pct_change (-21)',
                        ):
        ...
        # form4_df_post_proc = form4_df_post_proc[form4_df_post_proc[behind_price_column] < 0.]
        form4_df_post_proc = form4_df_post_proc[form4_df_post_proc[gspc_price_column] < 0.]
...
if __name__ == '__main__':
    ...
    processed_form4_df_model = PostProcessPosChangeLastGSPC.post_process_df(processed_4form_df)
    ...
    form4_df_cik_grouping_dict_post_proc = {ds_name: PostProcessPosChangeLastGSPC.post_process_df(form4_df_cik)
    ...
    form4_df_years_dict_post_proc = {ds_name: PostProcessPosChangeLastGSPC.post_process_df(form4_df_year)
