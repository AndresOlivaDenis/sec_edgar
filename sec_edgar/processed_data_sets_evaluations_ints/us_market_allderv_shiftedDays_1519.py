...
from sec_edgar.utils.evaluation_metrics_ints import PerformanceMetric01Ints, PerformanceMetric02Ints, PerformanceMetric03Ints
...
if __name__ == '__main__':
    ...
    metrics_df_01, _ = pe_4form.eval_metric(performance_metric_ref=PerformanceMetric01Ints,
    ...
    metrics_df_02, _ = pe_4form.eval_metric(performance_metric_ref=PerformanceMetric02Ints,
                                            pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                           shifted_columns_label_eval=
                                                           'Shifted Price pct_change (10)(-10 days +00:00:00)'))

    metrics_df_02b, _ = pe_4form.eval_metric(performance_metric_ref=PerformanceMetric02Ints,
                                             pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                            shifted_columns_label_eval=
                                                            'Shifted Price pct_change (10)(10 days 00:00:00)'))
    print("\nPerformanceMetric02 evaluation: ")
    ...
    metrics_df_03, _ = pe_4form.eval_metric(performance_metric_ref=PerformanceMetric03Ints,
                                            pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                           shifted_columns_label_eval=
                                                           'Shifted Price pct_change (10)(-10 days +00:00:00)'))

    metrics_df_03b, _ = pe_4form.eval_metric(performance_metric_ref=PerformanceMetric03Ints,
                                             pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                            shifted_columns_label_eval=
                                                            'Shifted Price pct_change (10)(10 days 00:00:00)'))
    ...
    # PerformanceMetric01 evaluation:
    metrics_df_01_year, _ = pe_4form_year.eval_metric(performance_metric_ref=PerformanceMetric01Ints,
                                                      pm_kwargs=dict(column_label_eval='Price pct_change (10)'))
    ...
    # PerformanceMetric02 evaluation:
    metrics_df_02_year, _ = pe_4form_year.eval_metric(performance_metric_ref=PerformanceMetric02Ints,
                                                      pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                                     shifted_columns_label_eval=
                                                                     'Shifted Price pct_change (10)(-10 days +00:00:00)'))

    metrics_df_02b_year, _ = pe_4form_year.eval_metric(performance_metric_ref=PerformanceMetric02Ints,
                                                       pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                                      shifted_columns_label_eval=
                                                                      'Shifted Price pct_change (10)(10 days 00:00:00)'))
    ...
    # PerformanceMetric03 evaluation:
    metrics_df_03_year, _ = pe_4form_year.eval_metric(performance_metric_ref=PerformanceMetric03Ints,
                                                      pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                                     shifted_columns_label_eval=
                                                                     'Shifted Price pct_change (10)(-10 days +00:00:00)'))

    metrics_df_03b_year, _ = pe_4form_year.eval_metric(performance_metric_ref=PerformanceMetric03Ints,
                                                       pm_kwargs=dict(column_label_eval='Price pct_change (10)',
                                                                      shifted_columns_label_eval=
                                                                      'Shifted Price pct_change (10)(10 days 00:00:00)'))
